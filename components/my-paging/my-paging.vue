...
<template>
	...
	<z-paging ref="paging" v-model="list" fixed auto-show-back-to-top refresher-threshold="160rpx" @query="queryList"
		...
		:innerListStyle="innerListStyle" :auto="auto" :auto-show-system-loading="showLoading" :default-page-size="defaultPageSize" :preloadPage="preloadPage"
		:cellHeightMode="cellHeightMode" :virtualScrollFps="virtualScrollFps"
...
<script>
	// import customNomore from '@/pagesZ/components/custom-nomore/custom-nomore.vue'
	// import customRefresher from '@/pagesZ/components/custom-refresher/custom-refresher.vue'
	export default {
		name: "my-paging",
		components: {
			// customNomore,
